...
public enum CorpErrorCode implements BaseErrorCode {
    ...
    PHONE_VALIDATION_DOES_NOT_EXIST(HttpStatus.UNAUTHORIZED, "CORP401", "회원 가입 휴대폰 인증이 변조되었거나 만료되어 존재하지 않습니다."),
    CORP_VALIDATION_FAILURE(HttpStatus.UNAUTHORIZED, "CORP401_2", "사업자 등록 조회 인증이 변조되었거나 만료되어 존재하지 않습니다."),
    ;
